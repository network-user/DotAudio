                ...
                ColumnLayout {
                    ...
                    Text {
                        ...
                        text: bridge.hotkeysAvailable
                              ...
                              : (bridge.platformName === "darwin"
                                 ? "Глобальные клавиши неактивны. Разрешите доступ в Системных настройках → Конфиденциальность → Универсальный доступ, затем перезапустите DotAudio."
                                 : "Глобальные клавиши недоступны (нет pynput/дисплея или Wayland без прав). Запускайте запись кнопкой или через окно приложения.")
                        color: Theme.muted
                        font.pixelSize: Theme.fsSmall
                        wrapMode: Text.Wrap
                    }
