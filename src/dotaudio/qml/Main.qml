            ...
            ColumnLayout {
                ...
                Repeater {
                    model: [
                        ...
                        {key:"speech_mode", title:"Язык/перевод", choices:["ru","en","multilingual","en_ru"]},
                ...
                Label { text: "EN→RU - локальный перевод после распознавания. Модель скачивается один раз."; wrapMode: Text.Wrap; Layout.fillWidth: true; color: "#81838a" }
            }
            ColumnLayout {
